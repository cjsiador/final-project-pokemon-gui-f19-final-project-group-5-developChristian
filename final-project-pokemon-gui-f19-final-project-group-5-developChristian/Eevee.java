...
* Single-type Normal implements one type interface
...
public class Eevee extends Pokemon implements NormalType {
  ...
  //booleans for telling which type attack to use for single type Pokemon
  ...
  */
   ...
   public Eevee() {
      super("Eevee", "Eevee", 133, NORMAL_COLOR, 0.30, 6.5,
  ...
  */
   ...
   public Eevee(String name) {
      super("Eevee", name, 133, NORMAL_COLOR, 0.30, 6.5,
         NORMAL_TYPE, "", BASE_ATTACK_POWER,
         BASE_DEFENSE_POWER, BASE_STAMINA_POWER);  
     //pick Attacks
      chooseFastAttack();
  ...
  *@param type1 The type 1 of this Pokemon.
  *@param type2 The type 2 of this Pokemon.
  ...
  */
   ...
   protected Eevee(String species, String name, int num, 
                   String color, double ht, double wt,
                   String type1, String type2, int baseAttackPwr, 
  ...
  */
   ...
   protected void chooseFastAttack() {
     ...
     //randomly choose to get Normal
      Random randGen = new Random();
      int index;
   
     //set attack type boolean
      fastIsNormal = true;
     // fastIsNormal = randGen.nextBoolean();
      if (fastIsNormal) {
 ...
 /**
  * Normal  specific special attack chooser.
  * Randomly picks whether attack type is Normal 
  ...
  */
   ...
   public String performFastAttack(Pokemon victim) {
     ...
     //check effectiveness of attack
      if (fastIsNormal) { //if attack is Normal-type     
  ...
  */
   ...
   public String performSpecialAttack(Pokemon victim) {
     ...
     //check effectiveness of attack
      ...
      if (specialIsNormal) { //if attack is Normal-type     
         if (vType.equals("Rock") || vType.equals("Steel")) {
